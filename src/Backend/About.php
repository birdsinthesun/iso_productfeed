...
class About
{
    ...
    public function getInfo(DataContainer $dc): void
    {
        ...
        if (System::getContainer()->get('contao.framework')->isBackend()) {   
            ...
            if (!$container->has('Bits\IsoProductfeed\Backend\About')) {
                throw new \RuntimeException('Service "Bits\IsoProductfeed\Backend\About" is not available.');
            }

            $aboutService = $container->get('Bits\IsoProductfeed\Backend\About');
